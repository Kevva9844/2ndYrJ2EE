      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Q & A</a>
          </div>
                ...
                <p class="category"><hr>
                        ...
                        connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
                            ...
                            <tr>
                                ...
                                <td style="border-bottom: 3px solid #F80000;padding-top: 25px; width: 1000px"><ul><li><a style="color: black;" href="industryanswer.jsp?id=<%=rs.getString("id")%>" ><%= rs.getString("title") %></a></li></ul></td>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <p class="category"><hr>
                         <!-- form login -->
                         <form action="AddQueestion2" method="post">
