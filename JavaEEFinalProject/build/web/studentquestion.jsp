                ...
                <p class="category"><hr>
                        ...
                        connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
                            ...
                            <tr>
                                ...
                                <td style="border-bottom: 3px solid #F80000;padding-top: 25px; width: 1000px"><ul><li><a style="color: black;" href="studentanswer.jsp?id=<%=rs.getString("id")%>" ><%= rs.getString("title") %></a></li></ul></td>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <p class="category"><hr>
                  ...
                  <input type="text" class="form-control" name="posted_by" readonly="readonly" style="width: 97%;" value=" <%=rs.getString(2)%>">
