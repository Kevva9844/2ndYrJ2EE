        ...
        <div class="row">
          ...
          <%
              try{
                    ...
                    PreparedStatement pst = connection.prepareStatement("SELECT * FROM event order by id desc");
            ...
            <div class="col-md-4">
              <div class="container">
                  <img src="images/<%= imgName%>" alt="<%= imgName%>" class="image" style="height: 200px; width: 100%;padding-top: 25px;">
                  <div class="middle">
                        <div class="text"><b><%=title%></b><br><%=date%> <br> <a href="Svieweventdetails.jsp?id=<%=id%>" style="color: black;">View Details</a></div>
                 </div>
