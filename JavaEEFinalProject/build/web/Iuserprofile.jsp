...
<body class="user-profile">
    ...
    try
    {
        ...
        String s1="select * from industry where username='"+u1+"'";
                  ...
                  <div class="row">
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" readonly="readonly" placeholder="Username" value=<%=rs.getString(1)%>>
                      </div>
                      <div class="form-group">
                        <label>Password</label>
                        <input type="text" class="form-control" name="password" value=<%=rs.getString(3)%>>
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" class="form-control" placeholder=<%=rs.getString(2)%>>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="" value=<%=rs.getString(4)%>>
                      </div>
