			...
			<h3>Job Details</h3>
                   ...
                   java.sql.Connection connection = null;
                    ...
                    try
                    {
                        ...
                        PreparedStatement pst = connection.prepareStatement(" SELECT * FROM job where id = '"+id+"' ");
                        ...
                        while(rs.next())
                        {
                            ...
                            String Qualitifications = rs.getString("Qualitifications");
                            String imgName =rs.getString("imgName");
                          /*  String contact_no = rs.getString("contact_no");*/
//                            int qid = rs.getInt("id");
                            request.setAttribute("Description", Description);
                            request.setAttribute("title", title);
                            request.setAttribute("Qualitifications", Qualitifications);
...
//                            session.setAttribute("qid", qid);
                ...
                %>
                               ...
                               <tr>
                                       ...
                                       <img src="images/jobimages/${imgName}" style="height: 150px;width: 150px;">
					
				</tr>
				<tr>
					<td>Company Name</td>
                                        <td><input type="text" name="title" required value="${companyName}" readonly="readonly"/></td>
				</tr>
                                <tr>
					<td>title</td>
					<td><input type="text" name="date"  required value="${title}" readonly="readonly"/></td>
				</tr>
				<tr>
					<td>Description</td>
				...
				<tr>
					...
					<td><textarea rows="3" cols="50" name="Qualifications"  required readonly="readonly"/>${Qualitifications}</textarea>
						</td>
						<!--<input type="text" name="description" placeholder="enter your description" required/>-->
				</tr>
