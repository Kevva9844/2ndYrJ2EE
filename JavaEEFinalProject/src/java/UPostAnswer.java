 ...
 * @author malith
 */
public class UPostAnswer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        {       
            ...
            if(comment.equals("") || comment == null)
            {
                ...
                out.println("location='universityanswer.jsp?id="+id+"'");
                out.println("</script>");
            }
            else
            {
                ...
                if(rs>0)
                    {
                        ...
                        out.println("location='universityanswer.jsp?id="+id+"'");
                        out.println("</script>");
                      RequestDispatcher requestDispatcher = request.getRequestDispatcher("/universityanswer.jsp?id=" + id);
            ...
            Logger.getLogger(UPostAnswer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
