 ...
 * @author malith
 */
public class IPostAnswer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        {       
            ...
            if(comment.equals("") || comment == null)
            {
                ...
                out.println("location='industryanswer.jsp?id="+id+"'");
                out.println("</script>");
            }
            else
            {
                ...
                if(rs>0)
                    {
                        ...
                        out.println("location='industryanswer.jsp?id="+id+"'");
                        out.println("</script>");
                      RequestDispatcher requestDispatcher = request.getRequestDispatcher("/industryanswer.jsp?id=" + id);
            ...
            Logger.getLogger(IPostAnswer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
